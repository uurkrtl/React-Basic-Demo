                ...
                <div className="col-md-6">
                    <div className="card flex-md-row mb-4 box-shadow h-md-250">
                        <div className="card-body d-flex flex-column align-items-start">
                            <strong className="d-inline-block mb-2 text-primary">{props.blogItem.category}</strong>
                            <h3 className="mb-0">
                                <a className="text-dark" href="#">{props.blogItem.title}</a>
                            </h3>
                            <div className="mb-1 text-muted">{props.blogItem.date}</div>
                            <p className="card-text mb-auto">{props.blogItem.description}</p>
